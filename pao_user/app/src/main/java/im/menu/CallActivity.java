    ...
    protected void onCreate(Bundle arg0) {
        ...
        pushProvider = new EMCallManager.EMCallPushProvider() {
            ...
            public void onRemoteOffline(final String to) {
                ...
                final EMMessage message = EMMessage.createTxtSendMessage("您有一条音视频消息", to);
                ...
                case MSG_CALL_MAKE_VOICE:
                    try {
                        ...
                        if (msg.what == MSG_CALL_MAKE_VIDEO) {
                            EMClient.getInstance().callManager().makeVideoCall(username, "123", record, merge);
                        } else {
                            EMClient.getInstance().callManager().makeVoiceCall(username, "123", record, merge);
                        }

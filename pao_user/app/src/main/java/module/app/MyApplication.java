...
//        PlatformConfig.setQQZone("", "");
         ...
         * 参数5:Push推送业务的secret
         */
        UMConfigure.init(this, "5e8fdac1dbc2ec07e86bbba6", channelName, UMConfigure.DEVICE_TYPE_PHONE, "");
    }

    //初始化环信
    public void initEMClient() {
        EMPushConfig.Builder builder = new EMPushConfig.Builder(app);
        builder.enableMeiZuPush("1009423", "c8defed2d1b6438eaf5f88f8ae56ed7a")
                .enableMiPush("2882303761518343189", "5801834384189")
                .enableOppoPush("f33d4285193549c3b54f024f2f068415", "19fda8359e934c7ea3de6de8422bc10e")

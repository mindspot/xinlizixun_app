    ...
    protected void initView(View rootView) {
        try {
            if (MyApplication.app.getServicePhoneResponseBean() != null &&
                    MyApplication.app.getServicePhoneResponseBean().getUserCustomers() != null
                    && !MyApplication.app.getServicePhoneResponseBean().getUserCustomers().isEmpty()) {
                phone = MyApplication.app.getServicePhoneResponseBean().getUserCustomers().get(0).getVal();

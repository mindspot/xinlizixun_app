...
public class MainActivity extends Base2Activity {
    ...
    private int[] mIconUnselectIds = {
            R.mipmap.home, R.mipmap.consult,
            R.mipmap.information, R.mipmap.article,
            R.mipmap.my};
    private int[] mIconSelectIds = {
            R.mipmap.home_click, R.mipmap.consult_click,
            R.mipmap.information_click, R.mipmap.article_click,
            R.mipmap.my_click};
    ...
    private void createFragment() {
        ...
        mData.add(new CounselFragment());
        mData.add(new MyEaseConversationFragment());
        mData.add(new ArtivlesFragment());
        mData.add(new MyCenterFragment());
    }

...
public class SelectSexAdapter extends EasyAdapter<ComprehensiveBean.SexItemBean> {
    public SelectSexAdapter(Page page) {
        super(page);
    }

    public void reset() {
        for (ComprehensiveBean.SexItemBean item : datas) {
            item.setCheck(false);
        }
    ...
    class ItemHolder extends EasySimpleViewHolder {
        ...
        @Override
        public void setData(ComprehensiveBean.SexItemBean data) {
            super.setData(data);

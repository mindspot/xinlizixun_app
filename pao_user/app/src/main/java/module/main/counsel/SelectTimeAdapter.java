...
public class SelectTimeAdapter extends EasyAdapter<TimeItemBean> {
    public SelectTimeAdapter(Page page) {
        super(page);
    }

    public void reset() {
        for (TimeItemBean item : datas) {
            item.setCheck(false);
        }
    ...
    class ItemHolder extends EasySimpleViewHolder {
        ...
        @Override
        public void setData(TimeItemBean data) {
            super.setData(data);

...
public class EaseShowBigImageActivity extends EaseBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadLayout = (LinearLayout) findViewById(R.id.load_view);
        ...
        if (!StringUtil.isBlank(imagePath)) {
            ...
            Glide.with(this).asBitmap().load(imagePath)
                    .apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.DATA)).listener(new RequestListener<Bitmap>() {
                @Override

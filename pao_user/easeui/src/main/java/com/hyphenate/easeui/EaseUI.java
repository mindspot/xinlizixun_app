    ...
    private void registerMessageListener() {
        EMClient.getInstance().chatManager().addMessageListener(new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                Log.d("IM-Listener", "onMessageReceived");
                EaseAtMessageHelper.get().parseMessages(messages);
                for (EMMessage item : messages) {
                    UserTabUtil.uploadUser(item.getFrom(), item.getStringAttribute(EaseConstant.EXTRA_USER_NICKNAME, ""),
                            item.getStringAttribute(EaseConstant.EXTRA_USER_AVATER, ""));
                }
            }

            @Override
            public void onMessageRead(List<EMMessage> messages) {
                Log.d("IM-Listener", "onMessageRead");
            }

            @Override
            public void onMessageDelivered(List<EMMessage> messages) {
                Log.d("IM-Listener", "onMessageDelivered");
            }

            @Override
            public void onMessageRecalled(List<EMMessage> messages) {
                Log.d("IM-Listener", "onMessageRecalled");
            }

            @Override
            public void onMessageChanged(EMMessage message, Object change) {
                Log.d("IM-Listener", "onMessageChanged");
            }

            @Override
            public void onCmdMessageReceived(List<EMMessage> messages) {
                Log.d("IM-Listener", "onCmdMessageReceived");
            }

            @Override
            public void onGroupMessageRead(List<EMGroupReadAck> groupReadAcks) {
                Log.d("IM-Listener", "onGroupMessageRead");

...
import com.hyphenate.easeui.widget.presenter.EaseChatOrderTextPresenter;
...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getType() == EMMessage.Type.TXT) {
            ...
            if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_ORDER, false)) {
    ...
    protected EaseChatRowPresenter createChatRowPresenter(EMMessage message, int position) {
        ...
        switch (message.getType()) {
            case TXT:
                ...
                } else if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_ORDER, false)) {
                    presenter = new EaseChatOrderTextPresenter();
                } else {

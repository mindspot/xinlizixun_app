...
import com.hyphenate.easeui.widget.chatrow.EaseChatRowOrderText;
...
public class EaseChatOrderTextPresenter extends EaseChatRowPresenter {
    private static final String TAG = "EaseChatTextPresenter";

    @Override
    protected EaseChatRow onCreateChatRow(Context cxt, EMMessage message, int position, BaseAdapter adapter) {
        return new EaseChatRowOrderText(cxt, message, position, adapter);
    }

...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_voice_selector,
...
//        messageList.setAvatarShape(1);
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            @Override
            public void onOrderInfoMessage(EMMessage message) {
                if (chatFragmentHelper == null) {
                    return;
                }
                chatFragmentHelper.onOrderInfoMessageClick(message);
            }
        });
    }
    ...
    public interface EaseChatFragmentHelper {
         ...
         * on message bubble clicked
         */
        void onOrderInfoMessageClick(EMMessage message);
    }

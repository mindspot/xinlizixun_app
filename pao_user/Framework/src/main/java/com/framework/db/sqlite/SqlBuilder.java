...
public class SqlBuilder {
	...
	public static List<KeyValue> getSaveKeyValueListByEntity(Object entity){
		...
		try {
			table = TableInfo.get(entity.getClass());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public static SqlInfo buildDeleteSql(Object entity) throws Exception{
		...
		if(idvalue == null ){
			throw new Exception("getDeleteSQL:"+entity.getClass()+" id value is null");
		}
	...
	public static SqlInfo buildDeleteSql(Class<?> clazz , Object idValue) throws Exception{
	...
	public static SqlInfo getUpdateSqlAsSqlInfo(Object entity) throws Exception{
	...
	public static SqlInfo getUpdateSqlAsSqlInfo(Object entity,String  strWhere) throws Exception{
		...
		if(keyValueList == null || keyValueList.size()==0) {
			throw new Exception("this entity["+entity.getClass()+"] has no property"); 
		}

...
public class AlipayNotifyParam {
	 private String appId;   
		...
		public String toString() {
			return "AlipayNotifyParam [appId=" + appId + ", tradeNo=" + tradeNo + ", outTradeNo=" + outTradeNo
					+ ", outBizNo=" + outBizNo + ", buyerId=" + buyerId + ", buyerLogonId=" + buyerLogonId
					+ ", sellerId=" + sellerId + ", sellerEmail=" + sellerEmail + ", tradeStatus=" + tradeStatus
					+ ", totalAmount=" + totalAmount + ", receiptAmount=" + receiptAmount + ", buyerPayAmount="
					+ buyerPayAmount + ", refundFee=" + refundFee + ", subject=" + subject + ", body=" + body
					+ ", gmtCreate=" + gmtCreate + ", gmtPayment=" + gmtPayment + ", gmtRefund=" + gmtRefund
					+ ", gmtClose=" + gmtClose + ", fundBillList=" + fundBillList + ", passbackParams=" + passbackParams
					+ "]";
		}

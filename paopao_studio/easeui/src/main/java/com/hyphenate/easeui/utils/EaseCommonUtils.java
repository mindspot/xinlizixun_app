...
public class EaseCommonUtils {
    ...
    public static String getMessageDigest(EMMessage message, Context context) {
        String digest = "";
        UserTabUtil.uploadUser(message.getFrom(), message.getStringAttribute(EaseConstant.EXTRA_USER_NICKNAME, ""),
                message.getStringAttribute(EaseConstant.EXTRA_USER_AVATER, ""));

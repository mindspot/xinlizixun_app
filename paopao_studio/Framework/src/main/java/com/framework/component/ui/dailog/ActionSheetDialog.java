...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog setNegativeButton(String text, boolean isBlod, final OnClickListener listener) {
        txt_cancel.setText(text);
        if (!isBlod) {
            txt_cancel.setTypeface(Typeface.DEFAULT);
        }
        txt_cancel.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public enum SheetItemColor {
        // 主题色
        Blue("#1782e0"), Red("#FD4A2E"), BLACK("#000000");

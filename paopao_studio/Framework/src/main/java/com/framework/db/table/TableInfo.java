 ...
 */
package com.framework.db.table;

import com.framework.db.ClassUtils;
import com.framework.db.FieldUtils;
...
public class TableInfo {
	...
	public static  TableInfo get(Class<?> clazz) throws Exception{
		if(clazz == null) 
			throw new Exception("table info get error,because the clazz is null");
		...
		if( tableInfo == null ){
			...
			if(idField != null){
				...
				throw new Exception("the class["+clazz+"]'s idField is null , \n you can define _id,id property or use annotation @id to solution this exception");
			}
		...
		if(tableInfo == null ) 
			throw new Exception("the class["+clazz+"]'s table is null");

...
public class VideoCallActivity extends CallActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IMHolder.getInstance().isVideoCalling = true;
        callType = 1;
        ...
        changeCamera = (ImageView) findViewById(R.id.iv_camera);
...
//                callHelper.startVideoRecord(PathUtil.getInstance().getVideoPath().getAbsolutePath());
        ...
        */
            case R.id.root_layout:
                ...
                break;
            case R.id.iv_camera: //switch camera
    ...
    protected void onDestroy() {
        IMHolder.getInstance().isVideoCalling = false;
        stopMonitor();
    ...
    public void onEventMainThread(ServiceWillStopEvent event) {
        if (tipDialog == null) {
            tipDialog = new TipDialog(VideoCallActivity.this);
        }

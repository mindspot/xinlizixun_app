...
public class UserCouncilorListFragment extends BaseFragment {

    public static final int TYPE_ORDER_UNFINSH = 0;
    public static final int TYPE_ORDER_FINSH = 1;
    @BindView(R.id.user_councilor_list_listView)
    ListView listView;
    @BindView(R.id.user_councilor_list_refresh)
    ...
    public UserCouncilorListFragment() {
    }

    @SuppressLint("ValidFragment")
    public UserCouncilorListFragment(int type) {
        this.mType = type;
    }

    @Override
    protected int getContentViewId() {
        return R.layout.fragment_user_councilor_list_layout;
    }
    ...
    public void getData() {
        ...
        bean.setType(mType);
        HttpApi.app().getUserCouncilorList(this, bean, new HttpCallback<CouncilorResponseBean>() {
            @Override

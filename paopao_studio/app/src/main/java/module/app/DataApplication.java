...
public class DataApplication extends BaseApplication {
    ...
    List<NowUserOrderDetailItemBean> councilorList;

    public List<NowUserOrderDetailItemBean> getCouncilorList() {
        return councilorList;
    }

    public void setCouncilorList(List<NowUserOrderDetailItemBean> councilorList) {
        this.councilorList = councilorList;
    }

    List<CouncilorItemBean> councilorItemList;

    public List<CouncilorItemBean> getCouncilorItemList() {
        return councilorItemList;
    }

    public void setCouncilorItemList(List<CouncilorItemBean> councilorItemList) {
        this.councilorItemList = councilorItemList;
    }

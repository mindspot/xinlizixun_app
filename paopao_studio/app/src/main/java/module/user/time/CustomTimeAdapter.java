...
public class CustomTimeAdapter extends EasyAdapter<SystemPlanTimeItemBean> {

    public CustomTimeAdapter(Page page) {
        super(page);
    }
    ...
    class ItemHolder extends EasySimpleViewHolder {
        ...
        @BindView(R.id.custom_time_item_time_text)
        TextView timeText;
        @BindView(R.id.custom_time_item_item_layout)
        LinearLayout itemLayout;
        @BindView(R.id.custom_time_item_bottom_line)
        View bottomLine;
        @BindView(R.id.custom_time_item_right_line)
        View rightLine;

        public ItemHolder(ViewGroup parent) {
            super(parent, R.layout.custom_time_item_layout);
        }

        @Override
        public void setData(SystemPlanTimeItemBean data) {
            super.setData(data);
            ...
            //背景
            if (data.getTimeType() == SystemPlanTimeItemBean.KEY_STATUS_REST) {
                if (position == 0) {//第一个
        ...
        protected void initLisenter() {
            ...
            root.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (data.getTimeType() == SystemPlanTimeItemBean.KEY_STATUS_USE) {
                        data.setTimeType(SystemPlanTimeItemBean.KEY_STATUS_REST);
                    } else if (data.getTimeType() == SystemPlanTimeItemBean.KEY_STATUS_REST) {
                        data.setTimeType(SystemPlanTimeItemBean.KEY_STATUS_USE);
                    }

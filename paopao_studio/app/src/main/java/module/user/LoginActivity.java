...
public class LoginActivity extends BaseActivity {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        tipDialog.setContent("1.\t入驻流程：点击“我要入驻”-》填写心理咨询师资质信息-》填写个人资料信息-》设置产品信息-》提交审核；\n" +
                "2.\t审核通过后，会收到审核通过的短信通知；咨询师可根据通知内容，登录app接单；\n" +
                "3.\t提交材料之后，咨询师可点击我要入驻，登录页面可直接查看入驻审核进度信息；\n" +
                "4.\t材料驳回后，咨询师可补充材料，重新申请入驻。\n");
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.login_activity_reg_agreement:
                toWebViewActivity("file:///android_asset/enter_agreement.htm");
                break;

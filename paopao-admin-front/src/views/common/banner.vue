<template>
  <div class="app-container">
    ...
    <el-table ref="multipleTable" :data="objectList" tooltip-effect="dark" style="width: 100%" border fit highlight-current-row @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="val" align="center" label="图片" width="480">
        <!-- 图片的显示 -->
      ...
      <el-table-column prop="valCode" label="状态" width="72">
        <template slot-scope="scope">
          <span v-if="scope.row.valCode === 0">不展示</span>
          <span v-if="scope.row.valCode === 1">展示</span>
        </template>
      </el-table-column>
      <el-table-column prop="link" align="center" label="地址" width="148">
         <template slot-scope="scope">
      ...
      <el-form ref="dataForm" :model="object" :label-width="formLabelWidth" :disabled="ifView">
        ...
        <el-row>
          <el-col :span="12"  style="padding:15px;">
             <el-form-item label="链接" prop="buttonNo">
              <el-input v-model="object.link" auto-complete="off" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="状态">
              <template>
                <el-radio v-model="radio" label="1" @change="bannerChange">展示</el-radio>
                <el-radio v-model="radio" label="0" @change="bannerChange">不展示</el-radio>
              </template>
            </el-form-item>
          </el-col>
        </el-row>

<template>
  <div class="app-container">
    ...
    <el-table ref="multipleTable" :data="objectList" tooltip-effect="dark" style="width: 100%" border fit highlight-current-row @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="val" align="center" label="分类名称" width="144" />
      <el-table-column prop="link" align="center" label="链接" width="144" />
      <el-table-column prop="sort" align="center" label="排序" width="144" />
